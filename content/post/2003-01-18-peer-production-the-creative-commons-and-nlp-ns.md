...
Benkler examines closely <cite cite="http://www.benkler.org/CoasesPenguin.PDF">(p55 ff)</cite> the motivation factors behind peer-production. The key factors are money (M) and socio-psychological (SP) rewards (which may effect one&#8217;s social standing &amp reputation and/or provide internal satisfaction). An individual&#8217;s motivation to contribute will depend on the combined reward exceeding some threshold that is relevant for them. SP rewards in particular are sensitive to a range of factors, including the nature of the project, the size of effort required to make a contribution, the economic status of the participant (e.g. if you are starving M becomes over-riding), the balance of direct and indirect monetary gain, the perceived fairness by which monetary rewards are appropriated etc. Quoting Benkler <cite cite="http://www.benkler.org/CoasesPenguin.PDF">(p61)</cite>, the sort of conditions to sustain peer-production are likely to be:

<blockquote cite="http://www.benkler.org/CoasesPenguin.PDF">
  <p>
...
Quality control is essential to any information production system. Benkler cites <cite cite="http://www.benkler.org/CoasesPenguin.PDF">(p68)</cite> examples of four approaches used in commons-based production:
...
The other area of possible concern is &#8220;defection&#8221; &#8211; i.e. behaviour by network members that threatens production (free-riding) or the motivation of members to contribute. Again referring to Benkler he observes <cite cite="http://www.benkler.org/CoasesPenguin.PDF">(p65 ff)</cite> that peer-production is resilient to free-riding because:
...
All of these factors mean nothing without contributors to the network &#8211; hence this advocacy piece. If you are involved in NLP or related fields in any way, drop me an email or make a comment on the site &#8211; let me know what you think&#8230;
 ...
 [2]: http://www.benkler.org/
 [3]: http://www.benkler.org/CoasesPenguin.PDF "Coase's Penguin, or, Linux and the Nature of the Firm [PDF 254kB]"
 [4]: http://www.creativecommons.org/ "Creative Commons"
 [5]: http://www.gnu.org/copyleft/gpl.html "GNU General Public Licence"
 [6]: #get-it
 [7]: http://www.gonzomarkets.com/cluetrain/markets.html "The Cluetrain Manifesto"
 [8]: http://www.nlpu.com/Values.html "Shared values of the NLP community"
 [9]: http://www.neurosemantics.com/Articles/Vision-INS.htm#THE NEURO-SEMANTIC VISION "The Neuro-Semantic Vision"
 [10]: http://cyberlaw.stanford.edu/lessig/blog/
 [11]: http://www.devco.demon.co.uk/
 [12]: http://www.nlpu.com/
 [13]: http://www.nlpu.com/Values.html
 [14]: http://www.neurosemantics.com/
 [15]: http://www.neurosemantics.com/Neuro-Semantics/Society_Defined.htm "INS Defined"
 [16]: http://www.creativecommons.org "Creative Commons"
 [17]: http://www.creativecommons.org/learn/licenses/ "Licences Explained | Creative Commons"
 [18]: http://creativecommons.org/licenses/by-nc-sa/1.0 "Attribution-NonCommercial-ShareAlike"
 [19]: http://creativecommons.org/licenses/by-sa/1.0 "Attribution-ShareAlike"